...
import { 
  BookOpen, Play, Trophy, Star, Clock, CheckCircle, 
  Lock, Target, Users, Award, TrendingUp, Video
} from 'lucide-react';
...
const LearningSection: React.FC<LearningSectionProps> = ({ user }) => {
  ...
  const learningModules = [
    {
      ...
      description: 'Learn to identify potential threats and stay alert in various environments',
      duration: '15 min',
      difficulty: 'Beginner',
      completed: true,
      locked: false,
    ...
    },
    {
      ...
      description: 'Essential moves and techniques to protect yourself in dangerous situations',
      duration: '25 min',
      difficulty: 'Beginner',
      completed: true,
      locked: false,
    ...
    },
    {
      ...
      description: 'Learn how to break free from grabs and escape dangerous situations',
      duration: '20 min',
    ...
    },
    {
      ...
      description: 'Advanced striking and defensive maneuvers for serious situations',
      duration: '30 min',
      difficulty: 'Advanced',
      completed: false,
      locked: true,
  ...
  const achievements = [
    ...
    { name: 'Quick Learner', description: 'Complete 3 modules in one day', earned: true },
    { name: 'Safety Expert', description: 'Complete all beginner modules', earned: true },
            ...
            <div className="grid gap-4">
              {learningModules.map((module) => (
                <div 
                  ...
                  onClick={() => !module.locked && setActiveModule(activeModule === module.id ? null : module.id)}
                >
                        ...
                        {Array.from({ length: module.lessons }, (_, i) => (
                          <div key={i} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">3-4 minutes</p>
                            </div>
